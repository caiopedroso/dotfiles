...
# Conda is set up but not automatically activated
# To activate conda, run: conda activate <environment>
# To activate base environment: conda activate base
...
# Disable automatic conda activation (suppress output to avoid instant prompt conflicts)
